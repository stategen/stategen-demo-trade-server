...
public class MenuDaoImpl extends SqlMapClientDaoSupport implements MenuDao {
    ...
    public Long deleteByMenuId(Long menuId) throws DataAccessException {
        ...
        return (long) getSqlMapClientTemplate().update("deleteByMenuId.Menu.trade", params);
    }
    ...
    public PageList<Menu> getMenuPageListByDefaultQuery(Menu menu, int pageSize, int pageNum) throws DataAccessException {
        return (PageList<Menu>) PageQueryUtils.pageQuery(getSqlMapClientTemplate(), "getMenuPageListByDefaultQuery.Menu.trade", menu, pageNum, pageSize);
    }
    ...
    public Long deleteByMenuIds(java.util.List<Long> menuIds) throws DataAccessException {
        Map<String, Object> params = new HashMap<String, Object>(1);
        params.put("menuIds", menuIds);
        return (long) getSqlMapClientTemplate().update("deleteByMenuIds.Menu.trade", params);
    }
    ...
    public List<Menu> getMenusByVisitType(org.stategen.framework.lite.enums.VisitType visitType, String projectName) throws DataAccessException {
        ...
        return (List<Menu>) getSqlMapClientTemplate().queryForList("getMenusByVisitType.Menu.trade", params);
    }
