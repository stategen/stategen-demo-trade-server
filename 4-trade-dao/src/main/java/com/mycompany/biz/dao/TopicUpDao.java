...
public interface TopicUpDao {
	...
	/**
    <pre>
    &#64;ApiParam() &#64;RequestParam(required = false) String upId,
    &#64;ApiParam() &#64;RequestParam(required = false) String objectId,
	...
	/**
    <pre>
    &#64;ApiParam("upId") &#64;RequestParam(required = false) String upId    
    </pre>
	 * 
    ...
    &#64;ApiParam("authorId") &#64;RequestParam(required = false) String authorId    
    </pre>
	 * 
	...
	/**
    <pre>
    &#64;ApiParam("objectId") &#64;RequestParam(required = false) String objectId,
    &#64;ApiParam("authorId") &#64;RequestParam(required = false) String authorId    
    </pre>
	 * 
