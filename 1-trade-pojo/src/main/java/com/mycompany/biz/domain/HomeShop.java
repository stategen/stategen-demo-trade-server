 ...
 * 同时，支持自定义修改字段大小写，一旦修改后，请再执行 gen.sh dal demo_home_shop -e
 * 不建议使@Data,其hashCode有问题
 * 如果表修改后 ，请执行 gen.sh table demo_home_shop -e ,再执行 gen.sh dal demo_home_shop -e
 * </pre>
 */
@Getter
@Setter
...
public class HomeShop extends Shop implements java.io.Serializable {
    ...
    /***homeShopId   db_column: home_shop_id VARCHAR */
    @ApiModelProperty("homeShopId")
    @Id
    @Max(64)
    ...
    public String toString() {
        ...
        sb.append('{');
        sb.append("homeShopIds").append('=').append(homeShopIds).append('\n');
        ...
        sb.append("homeShopId").append('=').append(getHomeShopId()).append('\n');
    ...
    /*** homeShopIds in getPageList */
    @ApiModelProperty("homeShopId s")
    @JSONField(serialize = false)
    private java.util.List<String> homeShopIds;
