 ...
 * 同时，支持自定义修改字段大小写，一旦修改后，请再执行 gen.sh dal demo_category -e
 * 不建议使@Data,其hashCode有问题
 * 如果表修改后 ，请执行 gen.sh table demo_category -e ,再执行 gen.sh dal demo_category -e
 * </pre>
 */
@Getter
@Setter
...
public class Category implements java.io.Serializable {
    ...
    public String toString() {
        ...
        sb.append("categoryNameLike").append('=').append(categoryNameLike).append('\n');
