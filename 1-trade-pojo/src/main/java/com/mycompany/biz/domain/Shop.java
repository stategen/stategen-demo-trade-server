 ...
 * 同时，支持自定义修改字段大小写，一旦修改后，请再执行 gen.sh dal demo_shop -e
 * 不建议使@Data,其hashCode有问题
 * 如果表修改后 ，请执行 gen.sh table demo_shop -e ,再执行 gen.sh dal demo_shop -e
 * </pre>
 */
@Getter
@Setter
...
public class Shop implements java.io.Serializable {
    ...
    public String toString() {
        ...
        sb.append("leaderPhoneLike").append('=').append(leaderPhoneLike).append('\n');
        ...
        sb.append("leaderImage").append('=').append(getLeaderImage()).append('\n');
        sb.append("leaderPhone").append('=').append(getLeaderPhone()).append('\n');
