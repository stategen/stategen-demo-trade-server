...
public interface SlideDao {
	 ...
	 * 
	 * sql:insert into slide ( create_time , update_time , delete_flag , slide_id , goods_id , image , urlType , order_no ) VALUES (CURRENT_TIMESTAMP(6),CURRENT_TIMESTAMP(6),0,?,?,?,?,?)
	 */
	 ...
	 * 
	 * sql:UPDATE slide SET delete_flag = 1 , update_time = CURRENT_TIMESTAMP(6) where delete_flag = 0 and slide_id = ?
	 */
	 ...
	 * 
	 * sql:UPDATE slide SET update_time= CURRENT_TIMESTAMP(6) , goods_id = ? , image = ? , urlType = ? , order_no = ? where delete_flag = 0 and slide_id = ?
	 */
	 ...
	 * 
	 * sql:select a.slide_id, a.goods_id, a.image, a.urlType, a.order_no, a.create_time, a.update_time, a.delete_flag from slide a where a.delete_flag = 0 and a.slide_id = ?
	 */
	 ...
	 * 
	 * sql:select a.slide_id, a.goods_id, a.image, a.urlType, a.order_no, a.create_time, a.update_time, a.delete_flag from slide a where a.delete_flag = 0 and 1=0 and a.slide_id in ( ? ) order by a.update_time desc, a.create_time desc
	 */
	 ...
	 * 
	 * sql:UPDATE slide SET delete_flag = 1 , update_time = CURRENT_TIMESTAMP(6) where delete_flag = 0 and 1=0 and slide_id in ( ? )
	 */
