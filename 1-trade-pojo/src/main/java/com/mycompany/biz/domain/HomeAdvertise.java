 ...
 * 同时，支持自定义修改字段大小写，一旦修改后，请再执行 gen.sh dal demo_home_advertise -e
 * 不建议使@Data,其hashCode有问题
 * 如果表修改后 ，请执行 gen.sh table demo_home_advertise -e ,再执行 gen.sh dal demo_home_advertise -e
 * </pre>
 */
@Getter
@Setter
...
public class HomeAdvertise extends AdvertisePicture implements java.io.Serializable {
    ...
    public String toString() {
        ...
        sb.append('{');
        sb.append("homeAdvIds").append('=').append(homeAdvIds).append('\n');
        ...
        sb.append("homeAdvId").append('=').append(getHomeAdvId()).append('\n');
