 ...
 * 同时，支持自定义修改字段大小写，一旦修改后，请再执行 gen.sh dal demo_organization -e
 * 不建议使@Data,其hashCode有问题
 * 如果表修改后 ，请执行 gen.sh table demo_organization -e ,再执行 gen.sh dal demo_organization -e
 * </pre>
 */
@Getter
@Setter
...
public class Organization implements java.io.Serializable {
    ...
    /***orgId   db_column: org_id BIGINT */
    @ApiModelProperty("orgId")
    @Id
    private Long orgId;

    /***parentId   db_column: parent_id BIGINT */
    ...
    /***orgType   db_column: org_type VARCHAR */
    ...
    public String toString() {
        ...
        sb.append("parentIds").append('=').append(parentIds).append('\n');
        sb.append("nameLike").append('=').append(nameLike).append('\n');
        sb.append("orgTypes").append('=').append(orgTypes).append('\n');
        ...
        sb.append("orgType").append('=').append(getOrgType()).append('\n');
    ...
    /*** orgIds in getPageList */
    @ApiModelProperty("orgId s")
    @JSONField(serialize = false)
    private java.util.List<Long> orgIds;

    /*** parentIds in getPageList */
    @ApiModelProperty("parentId s")
    @JSONField(serialize = false)
    ...
    /*** orgTypes in getPageList */
    @ApiModelProperty("orgType s")
    @JSONField(serialize = false)
    private java.util.List<String> orgTypes;
