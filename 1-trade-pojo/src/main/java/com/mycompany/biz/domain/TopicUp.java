 ...
 * 同时，支持自定义修改字段大小写，一旦修改后，请再执行 gen.sh dal demo_topic_up -e
 * 不建议使@Data,其hashCode有问题
 * 如果表修改后 ，请执行 gen.sh table demo_topic_up -e ,再执行 gen.sh dal demo_topic_up -e
 * </pre>
 */
@Getter
@Setter
...
public class TopicUp implements java.io.Serializable {
    ...
    public String toString() {
        ...
        sb.append('{');
        sb.append("upIds").append('=').append(upIds).append('\n');
        sb.append("objectIds").append('=').append(objectIds).append('\n');
        ...
        sb.append("upId").append('=').append(getUpId()).append('\n');
        sb.append("objectId").append('=').append(getObjectId()).append('\n');
