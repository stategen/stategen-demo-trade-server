...
public class RoleMenuDaoImpl extends SqlMapClientDaoSupport implements RoleMenuDao {
    ...
    public Long deleteById(Long id) throws DataAccessException {
        ...
        params.put("id", id);
        return (long) getSqlMapClientTemplate().update("deleteById.RoleMenu.trade", params);
    }
    ...
    public Long deleteByIds(java.util.List<Long> ids) throws DataAccessException {
        Map<String, Object> params = new HashMap<String, Object>(1);
        params.put("ids", ids);
        return (long) getSqlMapClientTemplate().update("deleteByIds.RoleMenu.trade", params);
    }
